<?php
$title = 'Editar Telefone de Emergência';
...
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-900">Editar Telefone de Emergência</h1>
    <p class="text-gray-600 mt-1">Atualize as informações do telefone de emergência</p>
</div>

<div class="bg-white rounded-lg shadow-sm">
    <div class="px-6 py-4 border-b border-gray-200">
        <h3 class="text-lg font-medium text-gray-900">Editar Telefone</h3>
    </div>
    
    <form method="POST" action="<?= url('admin/telefones-emergencia/' . $telefone['id']) ?>" class="p-6 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" 
                       name="numero" 
                       id="numero" 
                       value="<?= htmlspecialchars($data['numero'] ?? $telefone['numero']) ?>"
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="descricao" 
                          ...
                          placeholder="Ex: Telefone de emergência 24 horas"><?= htmlspecialchars($data['descricao'] ?? $telefone['descricao']) ?></textarea>
                <p class="mt-1 text-xs text-gray-500">
            ...
            <div class="md:col-span-2">
                <div class="flex items-center">
                    <input type="checkbox" 
                           ...
                           id="is_ativo" 
                           value="1"
                           <?= ($data['is_ativo'] ?? $telefone['is_ativo'] ?? 1) ? 'checked' : '' ?>
