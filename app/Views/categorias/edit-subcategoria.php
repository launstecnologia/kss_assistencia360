...
<div class="bg-white shadow rounded-lg">
    ...
    <form method="POST" action="<?= url('categorias/' . $categoria['id'] . '/subcategorias/' . $subcategoria['id']) ?>" class="p-6 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="number" 
                       name="tempo_estimado" 
                       id="tempo_estimado" 
                       value="<?= htmlspecialchars($data['tempo_estimado'] ?? $subcategoria['tempo_estimado']) ?>"
                       min="0"
                       step="0.5"
        ...
        <div class="border-t pt-6">
            ...
            <div class="p-4 bg-gray-50 rounded-lg">
                ...
                <div class="ml-14">
                    ...
                    <p id="preview-tempo" class="text-xs text-gray-500 mt-1" style="display: <?= ($data['tempo_estimado'] ?? $subcategoria['tempo_estimado']) ? 'block' : 'none' ?>">
                        <i class="fas fa-clock mr-1"></i>
                        Tempo estimado: <span id="preview-tempo-value"><?= htmlspecialchars($data['tempo_estimado'] ?? $subcategoria['tempo_estimado']) ?></span> horas
                    </p>
                </div>
            </div>
        </div>
